...
#TODO: How do we test the queries generated by pypika?
...
def test_build_unprocessed_query_different_years():
    ...
    sql_2000_2019 = _build_unprocessed_query(table, constants.TOP_WORDS_DEFAULT_LIMIT, constants.PROCESSED_DATA_START_YEAR, constants.PROCESSED_DATA_END_YEAR)
    ...
    sql_1500_1600 = _build_unprocessed_query(table, constants.TOP_WORDS_DEFAULT_LIMIT, 1500, 1600)
...
def test_build_unprocessed_query_single_year(in_memory_db: str):
    ...
    sql = _build_unprocessed_query(table, 10, constants.PROCESSED_DATA_START_YEAR, constants.PROCESSED_DATA_START_YEAR)
    result = conn.execute(sql)
    rows = result.fetchall()
...
def test_build_unprocessed_query_ordering(in_memory_db: str):
    ...
    sql = _build_unprocessed_query(table, 10, constants.PROCESSED_DATA_START_YEAR, constants.PROCESSED_DATA_END_YEAR)
    result = conn.execute(sql)
    rows = result.fetchall()
...
def test_query_limit_respected(in_memory_db: str):
    ...
    sql_unprocessed = _build_unprocessed_query(table_unprocessed, 5, constants.PROCESSED_DATA_START_YEAR, constants.PROCESSED_DATA_END_YEAR)
...
def test_preprocessed_vs_unprocessed_data_difference(in_memory_db: str):
    ...
    table_unprocessed = Table(constants.UNPROCESSED_TABLE_NAME)
    sql_unprocessed = _build_unprocessed_query(table_unprocessed, 1, constants.PROCESSED_DATA_START_YEAR, 2001)
